...
import uz.example.instaclone.fragment.HomeFragment
...
class HomeAdapter(var fragment: HomeFragment,var items:ArrayList<Post>) : BaseAdapter() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is PostViewHolder) {
            ...
            Glide.with(fragment).load(post.userImg).placeholder(R.drawable.avatar)
    ...
    class PostViewHolder(var view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            iv_profile = view.findViewById(R.id.siv_profile)
